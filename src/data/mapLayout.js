...
export const MAP_LAYOUT = {
  ...
  blocks: [
    ...
    },
    {
      ...
      name: '블록 3',
      x: 12, // 블록 2와 간격 (도로 1칸)
      // 블록 2의 오른쪽 끝: x=7 + 4 = 11
      // 블록 3의 왼쪽: x=12 (도로 1칸)
      // 블록 3의 오른쪽 끝: x=12 + 6 = 18
      y: 2,
      width: 6,
      height: 4,
      totalSize: 24,
    ...
    },
    {
      id: 'block5',
      name: '블록 5',
      x: 12, // 블록 3, 블록 6과 같은 오른쪽 선을 맞추기 위해
      // 블록 5의 오른쪽 끝: x=12 + 6 = 18 (블록 3, 블록 6과 같은 열)
      y: 7,
      width: 6,
      height: 6,
      totalSize: 36,
    ...
    },
    {
      id: 'block6',
      name: '블록 6',
      x: 2, // 블록 1의 왼쪽 선과 같은 열
      y: 14, // 두 번째 행 아래 (도로 1칸)
      width: 16, // 블록 3의 오른쪽 끝(18)과 맞추기 위해 16으로 조정
      height: 4,
  ...
  // 전체 맵 크기 (타일 단위)
  // 블록 1, 4, 6의 왼쪽 끝: x=2
  // 블록 3, 5, 6의 오른쪽 끝: x=18, 오른쪽 여백 2칸 = 20
